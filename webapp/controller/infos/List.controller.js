sap.ui.define(['jquery.sap.global', 'ozan/ons/controller/BaseController', 'sap/ui/model/json/JSONModel', 'sap/ui/model/Filter'], function(
	...
	"use strict";
	return BaseController.extend("ozan.ons.controller.infos.List", {
		onInit: function(oEvent) {
			...
			var oInfoModel = new JSONModel(jQuery.sap.getModulePath("ozan.ons.model", "/infos.json?lang=" + lang));
			this.getView().setModel(oInfoModel, "Infos");
		},
		...
		onSearch: function(oEvent) {
			...
			var list = this.getView().byId("InfosList");
		...
		onRefresh: function(oEvent) {
			var oModel = new JSONModel(jQuery.sap.getModulePath("ozan.ons.model", "/infos.json"));
			this.getView().setModel(oModel, "Infos");
		},
