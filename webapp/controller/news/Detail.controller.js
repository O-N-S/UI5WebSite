sap.ui.define(['jquery.sap.global', 'ozan/ons/controller/BaseController', 'sap/ui/model/json/JSONModel', 'sap/ui/model/Filter'], function(
	...
	"use strict";
	return BaseController.extend("ozan.ons.controller.news.Detail", {
		...
		_onObjectMatched: function(oEvent) {
			...
			var myModel = new JSONModel(jQuery.sap.getModulePath("ozan.ons.model", "/news.json?id=" + id));
		...
		onPrint: function(oEvent) {
			...
			var link = '<center><div style="font-size: 80%;">Link zur Webseite: <a href="http://www.ozan-sueel.de:8080/new/' + this._data.ID +
				'">O/N/S</a></div></center>';
