sap.ui.define(['jquery.sap.global', 'ozan/ons/controller/BaseController', 'sap/ui/model/json/JSONModel', 'sap/ui/model/Filter'], function(
	...
	"use strict";
	return BaseController.extend("ozan.ons.controller.glossary.Detail", {
		onInit: function(oEvent) {
			...
			oRouter.getRoute("glossaryDetail").attachPatternMatched(this._onObjectMatched, this);
		},
		_onObjectMatched: function(oEvent) {
			var id = oEvent.getParameter("arguments").id;
			var myModel = new JSONModel(jQuery.sap.getModulePath("ozan.ons.model", "/glossary.json?id=" + id));
		...
		onPrint: function(oEvent) {
			...
			var link = '<center><div style="font-size: 80%;">Link zur Webseite: <a href="http://www.ozan-sueel.de:8080/glossar/' + this._data.ID +
				'">O/N/S</a></div></center>';
			...
			var description = '<div style="padding-top: 20px; padding-bottom: 20px; font-style: italic;">' + this._data.DESCRIPTION_DE +
				'</div>';
