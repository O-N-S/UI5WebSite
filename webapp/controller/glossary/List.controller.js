sap.ui.define(['jquery.sap.global', 'ozan/ons/controller/BaseController', 'sap/ui/model/json/JSONModel', 'sap/ui/model/Filter'], function(
	...
	"use strict";
	return BaseController.extend("ozan.ons.controller.glossary.List", {
		onInit: function(oEvent) {
			...
			var oGlossaryModel = new JSONModel(jQuery.sap.getModulePath("ozan.ons.model", "/glossary.json?lang=" + lang));
			this.getView().setModel(oGlossaryModel, "Glossary");
		},
		onInfoNotFound: function(oEvent) {
			this.getRouter().getTargets().display("glossaryNotFound", {
				fromTarget: "glossaryList"
			});
		},
		onSearch: function(oEvent) {
			...
			var list = this.getView().byId("GlossaryList");
		...
		onSelect: function(oEvent) {
			...
			this.getRouter().navTo("glossaryDetail", {
				id: "" + id
			});
		},
		onRefresh: function(oEvent) {
			var oModel = new JSONModel(jQuery.sap.getModulePath("ozan.ons.model", "/glossary.json"));
			this.getView().setModel(oModel, "Glossary");
		},
		...
		onAdd: function(oEvent) {
			this.getRouter().navTo("addGlossary");
		}
